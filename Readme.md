...
### Docker Build Steps:
`docker build -t slippi-playback .`
```
docker run --rm slippi-playback --help
Faster Melee - Slippi (3.4.6) - Playback

A multi-platform GameCube/Wii emulator

Usage: /opt/Ishiiruka/build/Binaries/dolphin-emu-nogui [-e <file>] [-h] [-v]
